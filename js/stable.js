...
var dxSTable = function() 
{
	...
	this.paletteURL = ".";
	this.sortAscImage = this.paletteURL+"/assets/icons/navigation/svg/ic_expand_more_18px.svg";
	this.sortDescImage = this.paletteURL+"/assets/icons/navigation/svg/ic_expand_less_18px.svg";
